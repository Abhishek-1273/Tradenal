...
export const tradeFormSchema = z.object({
  ...
  setup: z.enum(['breakout', 'liquiditySweep', 'smc', 'ict', 'supportResistance', 'trendFollowing', 'scalp', 'swing', 'custom']).optional(),
  ...
  emotionAfter: z.enum(['happy', 'frustrated', 'angry', 'satisfied', 'neutral']).optional(),
